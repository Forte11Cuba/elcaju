...
fn wire__crate__api__wallet__Wallet_reclaim_proofs_by_ys_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Wallet_reclaim_proofs_by_ys",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, crate::api::error::Error>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = crate::api::wallet::Wallet::reclaim_proofs_by_ys(
                            &*api_that_guard,
                            api_ys,
                        )
                        .await?;
...
fn wire__crate__api__wallet__Wallet_refresh_balance_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Wallet_refresh_balance",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        ...
                        let api_that_guard = api_that_guard.unwrap();
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::wallet::Wallet::refresh_balance(&*api_that_guard).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn wire__crate__api__token__create_offline_token_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "create_offline_token",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_mint_url = <String>::sse_decode(&mut deserializer);
            let api_proofs_json = <String>::sse_decode(&mut deserializer);
            let api_memo = <Option<String>>::sse_decode(&mut deserializer);
            let api_unit = <Option<String>>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, crate::api::error::Error>((move || {
                let output_ok = crate::api::token::create_offline_token(
                    &api_mint_url,
                    &api_proofs_json,
                    api_memo,
                    api_unit,
